...
exports.createValidatorWithArgs = exports.createValueValidatorWithArgs = exports.createValueValidator = exports.valueValidator = exports.createValidator = exports.Validators = void 0;
...
var Validators = /** @class */ (function () {
    ...
    Validators.in = createValueValidatorWithArgs(function (val, values) { return values.includes(val); }, function (values) { return "Value must be one of ".concat(values.join(', ')); });
    ...
    Validators.enum = createValueValidatorWithArgs(function (value, enumObj) { return Object.values(enumObj).includes(value); }, function (enumObj) {
        return "Value must be one of ".concat(Object.values(enumObj)
            .filter(function (x) { return typeof enumObj[x] !== 'number'; })
            .join(', '));
    });
...
function createValueValidatorWithArgs(validate, defaultMessage) {
    var result = createValidatorWithArgs(function (_, e, args) {
        if (e.value === undefined || e.value === null)
            return true;
