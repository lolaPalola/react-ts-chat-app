...
var SqlDatabase = /** @class */ (function () {
    ...
    SqlDatabase.filterToRaw = function (repo, condition, sqlCommand, dbNames) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var r, b, _a, _b, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, filter_consumer_bridge_to_sql_request_js_1.dbNamesOf)(r.metadata)];
                    case 1:
                        _c = (_d.sent());
                        _d.label = 2;
                    case 2:
                ...
                switch (_g.label) {
                    ...
                    case 3:
                        ...
                        if (options.orderBy) {
                            ...
                            segs = [];
                            _loop_1 = function (s) {
                                if (s.field instanceof CompoundIdField_js_1.CompoundIdField) {
                    ...
                    case 1:
                        ...
                        try {
                            for (_a = tslib_1.__values(this.entity.fields), _b = _a.next(); !_b.done; _b = _a.next()) {
                                x = _b.value;
                                if (x instanceof CompoundIdField_js_1.CompoundIdField) {
                                }
