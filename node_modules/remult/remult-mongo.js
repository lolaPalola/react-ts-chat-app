                ...
                switch (_k.label) {
                    ...
                    case 1:
                        ...
                        try {
                            for (_b = tslib_1.__values(this.entity.fields), _c = _b.next(); !_c.done; _c = _b.next()) {
                                x = _c.value;
                                if (x instanceof index_js_1.CompoundIdField) {
                                    resultFilter = (0, resultCompoundIdFilter_js_1.resultCompoundIdFilter)(x, id, data);
                                }
                            }
                        }
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, this.find({
                                where: index_js_1.Filter.fromEntityFilter(this.entity, resultFilter),
