...
function buildEntityInfo(options) {
    ...
    try {
        for (var _e = tslib_1.__values(options.entities.map(function (e) { return options.remult.repo(e).metadata; })), _f = _e.next(); !_f.done; _f = _e.next()) {
            ...
            var relations = [];
            var ids = {};
            if (metadata.idMetadata.field instanceof CompoundIdField_js_1.CompoundIdField) {
                try {
                    for (var _g = (e_2 = void 0, tslib_1.__values(metadata.idMetadata.field.fields)), _h = _g.next(); !_h.done; _h = _g.next()) {
                        var field = _h.value;
                        ids[field.key] = true;
                    }
                }
                ...
                ids[metadata.idMetadata.field.key] = true;
